...
```
$ docker image tag invoice marvelousanything/invoice
$ docker push marvelousanything/invoice
$ docker image tag notification marvelousanything/notification
$ docker push marvelousanything/notification
$ docker image tag product marvelousanything/product
$ docker push marvelousanything/product
$ docker image tag store marvelousanything/store
$ docker push marvelousanything/store
```
...
```
$ kubectl get svc jhipster-prometheus -n jhipster
```
...
```
$ kubectl get svc jhipster-grafana -n jhipster
```
